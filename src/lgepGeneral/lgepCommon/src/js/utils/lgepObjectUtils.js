...
export const createItem = function (itemId, type, name, description, container, relationType = "contents") {
    ...
    return soaService.post('Core-2006-03-DataManagement', 'createItems', requestParam).then(response => {
        return response;
    }).catch(e => {
 ...
 * @returns 
 */
export const createRelation = function (relationType, primaryObject, secondaryObject, userData) {
    let requestParam = {
        input: [{
            // clientId: "String",
    ...
    return soaService.post('Core-2006-03-DataManagement', 'createRelations', requestParam);
};
 ...
 * @returns 
 */
export const revise2 = function (baseItemRevision, newRevId, name, description) {
    let requestParam = {
        info: [{
            // clientId: "String",
    ...
    return soaService.post('Core-2008-06-DataManagement', 'revise2', requestParam).then(response => {
