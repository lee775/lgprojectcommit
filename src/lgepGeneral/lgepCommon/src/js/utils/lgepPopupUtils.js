...
const initParams = function (view, caption = "popup", width = 300, height = 300, isModal = true, draggable = true, closable = true, reference, placement, openHookFunction, closeHookFunction) {
    let params = {
        declView: view,
        locals: {
 ...
 * @returns 
 */
export const openPopup2 = function (view, caption = "popup", width = 300, height = 300, isModal = true, draggable = true, closable = true, reference, placement, openHookFunction, closeHookFunction, closeByClickOutside = false) {
