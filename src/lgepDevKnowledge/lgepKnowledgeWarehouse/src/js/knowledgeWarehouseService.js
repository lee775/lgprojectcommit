...
let keyAndModel = {};
let divName;
issueName["파손"] = "파손,Crack,파괴,Glass 파손,Lid 파손,Leg 파손,Caulking 강도,Hing Crack,Screw 파단,Boss Crack,백화,Damper 파손,Damper 목부러짐,Disk 파손,파단,손상,부러짐,뜯김,강성,강도,떨어짐,찢어짐,동파,끊어짐,터짐,응력";
issueName["변형"] = "뒤틀림,변형,들뜸,부품음,Tub 변형,벌어짐,흔들림,seaming 벌어짐,찍힘,천공,호스 꺽임,Base 변형,휨,열변형,뭉그러짐,Plain washer 녹음,,구멍,찌그러짐,처짐,접힘,영구변형,소성변형,배부름,압흔,Hole";
issueName["외관"] = "인쇄 Crack,인쇄면 박리,인쇄 지워짐,백청,갈색화,도막균열,내식성 불량,Scratch,변색,부식,Sharp edge,도막 Crack,발청,녹발청,오염,벗겨짐,이염,주름,도막 벗겨짐,박리,단차,긁힘,황변,흑화,백화,물방울 맺힘,얼룩,거칠어짐,실밥풀림,말림";
...
issueName["조립성"] = "조립불량,Leg 체결력,오조립,풀림,오체결,오삽입,조립안됨,과체결,헛돔,유동,압입력,미체결,오체결,혼용,오결선,헐렁거림,조임,끄덕거림,압입불량,형합,편심,압입력,탈거력,Torque 부족,결합력,조임력,미조립";
issueName["동작성"] = "열림력,닫힘력,동작불량,댐핑력 상실,안열림,열림속도,열림각,닫힘시간,여닫음,개폐력,구속";
issueName["소음"] = "딱딱 소음,떨림 소음,닿임 소음,Lid 떨림 소음,Cavitation 소음,이상소음,소음,마찰소음,기어부 소음,급수 소음,pipe 진동음,공력소음,울림,Beep음,탈수 소음,공진음,정지소음";
issueName["진동"] = "떨림,진동,언바란스,UB,수직과도진동,수직진동,Striking,walking,공진,Belt 떨림,Chattering,탈수진동";
issueName["이상상태"] = "early release softner,이물투입,막힘,건조안됨,사이클 막힘,잔수,동결,DE 에러,AE,이물막힘,물고임,유량불량,Filter Net 막힘,이물 쌓임,발연,발열,배수불량,화재,오가열,역류,호스빠짐,물버림 에러,Disk 구속불량,베어링 분리,볼트 미제거,오사용,밸브 미작동,LE 에러,OE 발생,오감지,버튼 오작동,UE 발생,온도상승,폭발,발화,덕트막힘,LED 점멸,막힘,린트쌓임,필터막힘,탄화,기포,세제비산,불빛 샘,안닫힘,분리,장력 부족,CE,배수불량";
issueName["전기적 특성"] = "누전,단선,전열파괴,과전류,오결선,Lead Wire 결선,감전,Lead Wire 손상,Lead Wire 열경화,EMI 불만족,감지불량,피복손상,철손,동손,기계손,소손,전원꺼짐,이상전류,누설전류,과부하,저전압,과전압,결선,센서불량,단락,모터 발열,short";
...
issueName["외관/감성"] = "인쇄 Crack,인쇄면 박리,인쇄 지워짐,백청,갈색화,도막균열,내식성 불량,Scratch,변색,부식,Sharp edge,도막 Crack,발청,녹발청,오염,벗겨짐,이염,주름,도막 벗겨짐,박리,단차,긁힘,황변,흑화,백화,물방울 맺힘,얼룩,거칠어짐,실밥풀림,말림,터치감도,세탁력 불만,조작감,타는 냄새";
issueName["외관_감성"] = "인쇄 Crack,인쇄면 박리,인쇄 지워짐,백청,갈색화,도막균열,내식성 불량,Scratch,변색,부식,Sharp edge,도막 Crack,발청,녹발청,오염,벗겨짐,이염,주름,도막 벗겨짐,박리,단차,긁힘,황변,흑화,백화,물방울 맺힘,얼룩,거칠어짐,실밥풀림,말림,터치감도,세탁력 불만,조작감,타는 냄새";
issueName["전기적/화학적특성"] = "누전,단선,전열파괴,과전류,오결선,Lead Wire 결선,감전,Lead Wire 손상,Lead Wire 열경화,EMI 불만족,감지불량,피복손상,철손,동손,기계손,소손,전원꺼짐,이상전류,누설전류,과부하,저전압,과전압,결선,센서불량,단락,모터 발열,short,Chemical Attack";
issueName["전기적_화학적특성"] = "누전,단선,전열파괴,과전류,오결선,Lead Wire 결선,감전,Lead Wire 손상,Lead Wire 열경화,EMI 불만족,감지불량,피복손상,철손,동손,기계손,소손,전원꺼짐,이상전류,누설전류,과부하,저전압,과전압,결선,센서불량,단락,모터 발열,short,Chemical Attack";
issueName["전기적_화학적 특성"] = "누전,단선,전열파괴,과전류,오결선,Lead Wire 결선,감전,Lead Wire 손상,Lead Wire 열경화,EMI 불만족,감지불량,피복손상,철손,동손,기계손,소손,전원꺼짐,이상전류,누설전류,과부하,저전압,과전압,결선,센서불량,단락,모터 발열,short,Chemical Attack";
issueName["파손/탈거"] = "파손,Crack,파괴,Glass 파손,Lid 파손,Leg 파손,Caulking 강도,Hing Crack,Screw 파단,Boss Crack,백화,Damper 파손,Damper 목부러짐,Disk 파손,파단,손상,부러짐,뜯김,강성,강도,떨어짐,찢어짐,동파,끊어짐,터짐,응력,부품탈락,분리,파이프 탈거,탈거,베어링 내륜 탈거,볼트 탈거,Magnet 빠짐";
...
export async function loadTreeData(data, ctx) {
    ...
    try {
        ...
        let searchFolders = [];
        if (!folderUID) { //그룹명에 해당하는 폴더가 없을 때
        ...
        for (let folder of midFolders) {    // 중분류 하부에 있는 아이템들 집어 넣기
            if (folder.type.includes("Folder")) {
                if (!treeArray[folder.props.object_name.dbValues[0]]) { //treeArray 배열에 키값에 해당하는 값이 있을때
                    ...
                    if (Array.isArray(treeArray[folder.props.object_name.dbValues[0]])) { //treeArray 값이 [] 인것도 고려
        ...
        const ordered = {};
        Object.keys(treeArray).sort().forEach(function (key) {
    ...
    if (data.eventData === undefined) {
        ...
        if (data.eventData) {
            ...
            if (data.searchModel == 'panel' && data.eventMap["panelSearch"] != undefined) {
                ...
                if (data.eventMap["partTree.treeNodeSelected"].node.children
                    && data.eventMap["partTree.treeNodeSelected"].node.children.length < 0) {
        ...
        try {
            ...
            //console.log(err);
            message.show(1, "이미지 로드 중 오류가 발생했습니다.");
        }
        //뷰모델로 전환
        checkList = revisions;
        let vmoList = [];
...
export async function loadQNA(data, ctx) {
    ...
    try {
        ...
        //console.log(err);
        message.show(1, "질문 로드 중 오류가 발생하였습니다.");
    }
    // 답변 리비전조회
    let answerList = [];
    ...
    try {
        ...
        //console.log(err);
        message.show(1, "답변 로드 중 오류가 발생했습니다.");
    }
    let vmoArray1 = [];
    let searchQList = {};
    for (let mo of qList) {
...
export async function countTree(data) {
    try {
        ...
        message.show(1, "자료 개수 로드 중 오류가 발생했습니다.");
        loadUtils.closeWindow(data);
    }
    ...
    if (urlAttrSearch.length > 1) {
        ...
        if (attrs.parent || attrs.child) {
            ...
            let eventData = {
                "folder": search, "parent": parent, "target": target, "pno": "", "mno": "",
                "source": "", "modelNo": "", "period": null, "allign": "", "uid": uid, "using": "url"
            };
            ...
            let eventData = {
                "folder": search, "parent": parent, "target": target,
                "pno": "", "mno": "", "source": "", "modelNo": "", "period": null, "allign": "", "uid": uid, "using": "url"
            };
            await showChildTest(data, "", target);
            eventBus.publish("panelSearch", eventData);
        }
...
async function showChildTest(data, a, text) {
    ...
    try {
        ...
        // console.log(err)
        message.show(1, "하위 자료 탐색중 오류 발생");
    }
    let searchCount = {};
...
async function getCountData(prop1) {
    ...
    try {
        ...
        message.show(1, "파일 개수 로드 중 에러가 발생하였습니다.");
        return;
    }
}
