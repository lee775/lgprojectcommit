...
export async function expertStateChange(data) {
    ...
    message.show(0, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "expertStateChange"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
        function () { }
    ]);
...
export function userExpertSelectedCheck(value) {
    if (value.expertDataProvider.selectedObjects.length <= 0) {
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "noneSelUser"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
            function () { }
        ]);
        return {
...
export async function paymentPoint(data) {
    ...
    if (isNaN(data.userPoint.dbValue)) {
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "onlyNumber"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
            function () { }
        ]);
        return {
            isNumber: false
    ...
    try {
        ...
        //console.log(err);
        message.show(2, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "pointEditFail"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
            function () { }
        ]);
        return {
            isNumber: true
    ...
    message.show(0, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "pointEditSuccess"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
        function () { }
    ]);
...
export function userSelectedCheck(value) {
    if (value.userDataProvider.selectedObjects.length <= 0) {
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "pointEditUserSel"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
            function () { }
        ]);
        return {
...
export async function getUserTable() {
    ...
    await com.getProperties(userData, ["l2_is_expert", "l2_answer_count", "l2_point", "l2_knowledge_count", "l2_user_name", "l2_user_id", "l2_selected_knowledge_count", "l2_good_count", "l2_expert_coverages"]);
...
export async function likeUp(value, data, ctx) {
    if (value) {
        ...
        if (likeOverlap) {
            ...
            message.show(1, lgepLocalizationUtils.getLocalizedText("lgepKnowldegeManageMessages", "checkDislike"), [lgepLocalizationUtils.getLocalizedText("lgepKnowldegeManageMessages", "yes"), lgepLocalizationUtils.getLocalizedText("lgepKnowldegeManageMessages", "no")], [
                async function () {
                    ...
                    message.show(0, lgepLocalizationUtils.getLocalizedText("lgepKnowldegeManageMessages", "checkClickDislike"), null, [
                        function () { }
                    ]);
                    inLabel(value, data);
            ...
            try {
                ...
                message.show(0, lgepLocalizationUtils.getLocalizedText("lgepKnowldegeManageMessages", "checkClickLike"), null, [
                    function () { }
                ]);
                inLabel(value, data);
...
export async function editTechnicalDocument(data) {
    ...
    if (contentString == null || contentString == "" || contentString == "<p><br></p>") {
        ...
        try {
            ...
            message.show(0, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "editSuccess"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
                function () { }
            ]);
...
export function tableSelectedCheck(value) {
    if (value.technicalDataProvider.selectedObjects.length <= 0) {
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "editDocumentSel"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
            function () { }
        ]);
        return {
...
export async function createTechnicalDocument(data) {
    ...
    if (contentString == null || contentString == "" || contentString == "<p><br></p>") {
        ...
        try {
            ...
            message.show(0, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "documentAddSuccess"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
                function () { }
            ]);
            datasetUid = null;
...
export function deleteTechnical(value) {
    if (value == null || value == undefined) {
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "deleteDocument"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
            function () { }
        ]);
        return;
    }

    message.show(1, "[ " + value.props.object_name.dbValue + " ]" + lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "realDelete"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "delete"), lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "cancel")], [
        async function () {
            ...
            try {
                ...
                reLoad();
                message.show(0, lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "deleteSuccess"), [lgepLocalizationUtils.getLocalizedText("lgepTechnicalMessages", "close")], [
                    function () { }
                ]);
