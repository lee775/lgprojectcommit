...
export function answerChange(data, ctx) {
    ...
    if (htmlData.window == "askExpert") {
        ...
        } else if ((htmlData.dataProviders.qaListDataProvider.selectedObjects[0].props.l2_experts.uiValue) && (htmlData.dataProviders.qaListDataProvider.selectedObjects[0].props.l2_experts.uiValue) !== ctx.user.props.user_name.dbValue) {
