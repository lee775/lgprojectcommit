...
export async function pagingAfterAction( data, subPanelContext ) {
    ...
    if ( num === data.dataProviders.chipPagingDataProvider.viewModelCollection.loadedVMObjects[ data.dataProviders.chipPagingDataProvider.viewModelCollection.loadedVMObjects.length - 1 ].labelDisplayName ) {
        data.dataProviders.chipPagingDataProvider.viewModelCollection.loadedVMObjects.splice( 0 );
        for( let pageList of AllPage ) {
...
export async function lastPageAction( data, subPanelContext ) {
    ...
    data.dataProviders.chipPagingDataProvider.viewModelCollection.loadedVMObjects[ data.dataProviders.chipPagingDataProvider.viewModelCollection.loadedVMObjects.length - 1 ].selected = true;
