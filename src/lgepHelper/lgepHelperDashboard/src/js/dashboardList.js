...
export async function loadProfile(data, ctx) {
    ...
    types: [
      {
        ...
        properties: [{ name: 'object_name' }, { name: 'owning_user' }, { name: 'owning_group' }],
      },
    ],
  };
  let params2 = {
    types: [
      {
        name: 'WorkspaceObject',
        properties: [{ name: 'object_name' }, { name: 'owning_user' }, { name: 'owning_group' }, { name: 'l2_is_selected' }],
      },
    ],
  };
  ...
  await Promise.all([
    ...
    _.forEach(answerResult, function (value) {
      if (
        value.type == 'L2_AnswerRevision' &&
        value.props.l2_is_selected.value == 'Y' &&
        value.props.owning_group.uiValues[0] == userG &&
        value.props.owning_user.uiValues[0] == userN
      ) {
  ...
  let l2UserProps = await com.getProperties(l2User, [
    'l2_is_expert',
    'l2_expert_coverages',
    'l2_point',
    'l2_knowledge_count',
...
export async function loadAskExpertList(data) {
  ...
  setTimeout(function () {
    data.dataProviders.qnaChipDataProvider.viewModelCollection.loadedVMObjects[0] != undefined
      ? (data.dataProviders.qnaChipDataProvider.viewModelCollection.loadedVMObjects[0].selected = true)
      : '';
    data.dataProviders.frequencyChipDataProvider.viewModelCollection.loadedVMObjects[0] != undefined
      ? (data.dataProviders.frequencyChipDataProvider.viewModelCollection.loadedVMObjects[0].selected = true)
      : '';
    data.dataProviders.searchChipDataProvider.viewModelCollection.loadedVMObjects[0] != undefined
      ? (data.dataProviders.searchChipDataProvider.viewModelCollection.loadedVMObjects[0].selected = true)
      : '';
    data.dataProviders.techDocChipDataProvider.viewModelCollection.loadedVMObjects[0] != undefined
      ? (data.dataProviders.techDocChipDataProvider.viewModelCollection.loadedVMObjects[0].selected = true)
      : '';
    data.dataProviders.faqChipDataProvider.viewModelCollection.loadedVMObjects[0] != undefined
      ? (data.dataProviders.faqChipDataProvider.viewModelCollection.loadedVMObjects[0].selected = true)
      : '';
    data.dataProviders.askExpertChipDataProvider.viewModelCollection.loadedVMObjects[0] != undefined
