...
export async function linkRelationsSequence() {
    ...
    message.show(0, lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "fileAttachComplete"), [lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "close")], [
        function () {}
    ]);
    datasetUid = null;
...
export async function deleteRelationsSequence(data) {
    ...
    if(deleteDataSet.length < 1){
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "noSelectDataset"), [lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "close")], [
            function () {}
        ]);
        return;
    }
