...
export function selectDatasetItem(value, data) {
    ...
    if (value.type == "L2_DgnPageRevision") {
        ...
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "firstSelectSequence"), [lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "close")], [
            function () {}
        ]);
        return {
            resultDatasetSel: false
...
export async function deleteSequenceRelationAndObject(value) {
    if(value == undefined){
        message.show(1,lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "deleteCheck"), [lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "close")], function () {});
        return;
    }
    if (value.type != "Folder") {
        const sequenceData = vms.getViewModelUsingElement(document.getElementById("designSequenceViewData"));
        message.show(1, value.props.object_string.uiValues + lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "noneFolderDelete"), [lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "delete"),lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "close")], [
            async function () {
        ...
        message.show(1, value.props.object_string.uiValues + lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "folderDelete"), [lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "delete"),lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "close")], [
            async function () {
                childDel(value);
                try {
                    let deleteObj = {
