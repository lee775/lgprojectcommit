...
export function information(data) {
    ...
    if (data.dataProviders.designStdData.selectedObjects.length > 1) {
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "oneSelectCheck"), [lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "close")], [function () {}]);
        return {
            informationState: false
        };
    } else if (data.dataProviders.designStdData.selectedObjects.length < 1) {
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "itemSelectCheck"), [lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "close")], [function () {}]);
        return {
            informationState: false
        };
    } else {
...
export async function selEditData(data) {
    ...
    if (data != undefined) {
        ...
        message.show(1, lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "editCheck"), [lgepLocalizationUtils.getLocalizedText("lgepDesignSequenceMessages", "close")], [
            function () {}
        ]);
        return {
            result: false
