...
$(document).on("click", "#pageAllSearchId", function () {
    const inputElWidth = document.querySelector("#pageAllSearchId").offsetWidth;
    popupService.show({
        declView: "L2_DesignStandardRecentSearch",
        options: {
            clickOutsideToClose: true,
            isModal: false,
            reference: "pageAllSearchId",
...
$(document).on("click", "#dgnPageSearchId", function () {
    const inputElWidth = document.querySelector("#dgnPageSearchId").offsetWidth;
    popupService.show({
        declView: "L2_DesignStandardRecentSearch",
        options: {
            clickOutsideToClose: true,
            isModal: false,
            reference: "dgnPageSearchId",
            placement: "bottom-start",
            width: inputElWidth
        },
        outputData: {
...
$(document).on("click", "#dgnPageSearchingId", function () {
    const inputElWidth = document.querySelector("#dgnPageSearchingId").offsetWidth;
    popupService.show({
        declView: "L2_DesignStandardRecentSearch",
        options: {
            clickOutsideToClose: true,
            isModal: false,
            reference: "dgnPageSearchingId",
            placement: "bottom-start",
            width: inputElWidth
        },
        outputData: {
...
async function addMainFolder() {
    ...
    if (!name || name == "") {
        message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "noName"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], []);
        return {
            state: "0"
        };
    }
    try {
        let createFolder;
        if (!designStdTreeData.dataProviders.designStandardTreeTableData.selectedObjects[0] || !designStdTreeData.dataProviders.designStandardTreeTableData.selectedObjects[0].type.includes("Folder")) {
...
function awtreeSearching(data) {
    ...
    for (let i = 0; i < treePageNameArr.length; i++) {
        ...
        let state = false;
        if (treePageNameArr[i].includes(searchValue)) {
            count++;
            state = true;
        }
        if (!state) {
            if (treePageContentStringArr[i].includes(searchValue)) {
                count++;
            }
        }
    }
        ...
        if (PageNameTemp.includes(searchValue) || pageContentTemp.includes(searchValue)) {
            ...
            for (let j = 0; j < reSearchingArr.length; j++) {
                if (reSearchingArr[j].uid == treePageArr[i].uid) {
                    reSearchingState = true;
                    break;
                }
            }
            if (!reSearchingState) {
                searchSuccess = true;
                bomlineTreeData.page = count - (count - (reSearchingArr.length + 1));
...
async function deleteCmdAction() {
    ...
    await common.userLogsInsert("Delete dgnPage2", selectedValue.uid, "S", "Success");
}
...
async function childViewOpen(value) {
    if (!value.type.includes("Page")) {
        let state;
        message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "childListView"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "open"), lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], [
            function () {
                state = true;
            },
            function () {
    ...
    if (!selectedValuePage.type.includes("Page")) {
        ...
        if (bomlineTreeData.searchMode) {
            if (searchValueStyle) {
                ...
                // let tp = tspanTemp.filter((element) => {return (element.includes(searchValueStyle));});
                for (let i = 0; i < tspanTemp.length; i++) {
                    if (tspanTemp[i].includes(searchValueStyle)) {
                ...
                $('#designStandardSummernote').summernote('reset');
                $('#designStandardSummernote').summernote('code', tspanTemp + '<br>');
            }
        }
        summernoteCodeTemp = $('#designStandardSummernote').summernote('code');
...
async function createDgnChapter(data) {
    ...
    message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "createSuccessChapter"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], [
        function () {
            bomlineTreeSet2();
        }
    ]);
...
async function createDgnPage(data, ctx) {
    ...
    if (name == "" || contents == "") {
        message.show(1, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "noEmptyProps"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], []);
        return {
            state: 0
        };
    }
    ...
    try {
        ...
        contentsType ? request.attributes.l2_content_type = {
            stringVec: [contentsType]
        } : [""];

        contentsDetailType ? request.attributes.l2_content_detail_type = {
            stringVec: [contentsDetailType]
        } : [""];

        test = await SoaService.post("Core-2007-01-DataManagement", "setProperties", request);
        request = {
        ...
        test = await SoaService.post("Core-2007-01-DataManagement", "setProperties", request);
        test = await lgepSummerNoteUtils.txtFileToDataset(contents, createItemRev);
    } catch (err) {
    ...
    message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "createSuccessPage"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], [
        function () {
            bomlineTreeSet2();
        }
    ]);
...
async function editDgnChapter(data) {
    ...
    message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "editSuccessChapter"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], [
        function () {
            bomlineTreeSet2();
        }
    ]);
...
async function editDgnPage(data) {
    ...
    let contentsString = lgepSummerNoteUtils.stripTags(contents);
    if (name == "" || name == null) {
        message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "noEmptyProps"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], []);
        return {
            state: 0
        };
    }
    ...
    message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "editSuccessPage"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], [
        function () {
            bomlineTreeSet2();
        }
    ]);
...
function bomlineAdd() {
    if (selectedAwTreeNode == undefined) {
        message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "pageAddPosition"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], []);
        return {
            treeSelect: false
        };
    } else {
        ...
        if (parentObj.type.includes("Page")) {
            message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "pageAddBookChapter"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], []);
            return {
                treeSelect: false
            };
        } else {
...
function bomlineEdit() {
    ...
    if (selectedAwTreeNode == undefined) {
        message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "dgnPagenoSelect"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], []);
        return {
            treeSelect: false
        };
    }
...
async function selFolderCheck() {
    ...
    if (valueObj.props.revision_list) {
        ...
        message.show(0, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "bookAddFolder"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], []);
        return {
            folder: false
        }
    }
...
async function createDgnBook(data, file) {
    ...
    if (itemName && itemName != "") {
        ...
        message.show(1, lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "noProperty"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "close")], []);
        return {
            state: 0
        };
    }
...
async function bomlineTreeSet(data) {
    try {
        ...
        message.show(0, selectedValue.props.object_name.dbValues[0] + lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "openBook"), [lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "open"), lgepLocalizationUtils.getLocalizedText("L2_DesignStandardMessages", "cancle")], [
            function () {
                const standardNavData = vms.getViewModelUsingElement(document.getElementById("stdTreeNavData"));
...
async function bomlineTreeSet2(passItem) {
    ...
    if (!passItem) {
        if (!selectedValue) {
            if (!standardData.dataProviders.designStandardTreeTableData.selectedObjects[0] || !standardData.dataProviders.designStandardTreeTableData.selectedObjects[0].type.includes("Book")) {
...
async function designStdContentLoad(ctx, data) {
    ...
    if (!selectedValue.props.revision_list) {
        selectedValue = com.getObject(selectedValue.uid);
    }
    if (!selectedValue.props.revision_list) {
        await com.getProperties(selectedValue, ["revision_list"]);
    }
    ...
    L2DesignStandardData.revisionListBox.uiValue = L2DesignStandardData.revisionListBoxValues.dbValues[L2DesignStandardData.revisionListBoxValues.dbValues.length - 1].propDisplayValue;
    standardData.dataProviders.designStandardTreeTableData.selectNone();
    return {
        selPage: true
    };
...
async function loadEmployeeTreeTableData(result, nodeBeingExpanded, sortCriteria, input, ctx) {
    ...
    await com.getProperties(response, ["object_string", "awb0BomLineItemId", "contents", "l2_reference_book", "object_desc", "fnd0InProcess", "ics_subclass_name", "object_type", "checked_out", "owning_user", "owning_group", "last_mod_date", "release_statuses", "object_name", "revision_list", "bl_all_child_lines", "bl_child_item", "bl_child_lines", "nx0AllChildren"]);
